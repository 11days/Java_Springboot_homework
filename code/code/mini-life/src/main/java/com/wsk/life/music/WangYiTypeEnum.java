...
public class WangYiTypeEnum {
    ...
    public static final String LYRIC_CACHE = "wangyi:yric:cache:";
    //    评论缓存
    //wangyi_comments_ + id
    public static final String COMMENT_CACHE = "wangyi:comment:cache:";

    //图片地址
    public static final String MUSIC_PIC = "https://music.163.com/api/song/detail/?";

    public static final String HOTTING_MUSIC = "https://music.163.com/discover/toplist?id=19723756";//云音乐飙升榜-2

    public static final String NEW_MUSIC = "https://music.163.com/discover/toplist?id=3779629";//云音乐新歌榜-3

    public static final String HOT_MUSIC = "https://music.163.com/discover/toplist?id=3778678";//云音乐热歌榜-1
